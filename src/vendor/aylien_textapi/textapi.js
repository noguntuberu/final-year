...
function AYLIENTextAPI(options) {
  ...
  this.entityLevelSentiment = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.aspectBasedSentiment = async function(params) {
    if (!params.domain) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.extract = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.language = async function(params) {
   ...
   * @param     {callback}      callback - The callback that handles the response
   */
  this.classify = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.classifyByTaxonomy = async function(params) {
    if (!params.taxonomy) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.combined = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.concepts = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.entities = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.hashtags = async function(params) {
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.summarize = async function(params) {
 ...
 /**
   ...
   * @param     {callback}  callback - The callback that handles the response
   */
  this.imageTags = async function(params) {
